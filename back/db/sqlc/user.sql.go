...
func (q *Queries) CreateUser(ctx context.Context, arg CreateUserParams) (User, error) {
	row := q.db.QueryRow(ctx, createUser, arg.Email, arg.Name, arg.Companions)
	var i User
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
...
SELECT id, created_at, updated_at, email, name, role, companions FROM users WHERE id = $1 LIMIT 1
`
...
SELECT id, created_at, updated_at, email, name, role, companions FROM users ORDER BY id LIMIT $1 OFFSET $2
`
